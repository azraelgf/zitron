(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".recommendation")) new Swiper(".recommendation", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".product-single__body")) {
            let thumbsSwiper;
            let mainSwiper;
            function initProductSingleSlider() {
                ...
                mainSwiper = new Swiper(".product-single__body", {
                    modules: [ Thumb ],
                    spaceBetween: 10,
                    slidesPerView: 1,
                    observer: true,
            ...
            if (document.querySelector(".product-single__body")) initProductSingleSlider();
            let resizeTimer;
